...
func (p tyRune) GoType() reflect.Type {
...
// NewInstance creates a new instance of a qlang type. required by `qlang type` spec.
//
func (p tyRune) NewInstance(args ...interface{}) interface{} {
...
func (p tyRune) Call(a interface{}) rune {

	return Rune(a)
}

func (p tyRune) String() string {

	return "rune"
}

// TyRune represents the `rune` type.
//
var TyRune = tyRune(0)
