...
var Exports = map[string]interface{}{
	...
	"GetNextMonthStart":           tk.GetNextMonthStart,
	"BytesContains":               tk.BytesContains,
	...
	"ReflectCallMethodCompact":     tk.ReflectCallMethodCompact,
	"ReflectCallFuncQuick":         tk.ReflectCallFuncQuick,
	"ReflectCallFuncCompact":       tk.ReflectCallFuncCompact,
	...
	"RecordsToMapStringMap":        tk.RecordsToMapStringMap,
	"RecordsToOrderedMapArray":     tk.RecordsToOrderedMapArray,
	"RecordsToOrderedMapStringMap": tk.RecordsToOrderedMapStringMap,
	...
	"TimeStampToTime":              tk.TimeStampToTime,
	...
	"AdjustBigFloat":                      tk.AdjustBigFloat,
	"ArrayContains":                       tk.ArrayContains,
	"GetArrayItem":                        tk.GetArrayItem,
	"GetArraySlice":                       tk.GetArraySlice,
	"GetMapItem":                          tk.GetMapItem,
	"GetNegativeResult":                   tk.GetNegativeResult,
	"GetLogicalNotResult":                 tk.GetLogicalNotResult,
	"GetBitNotResult":                     tk.GetBitNotResult,
	"GetBitANDResult":                     tk.GetBitANDResult,
	"GetBitORResult":                      tk.GetBitORResult,
	"GetBitXORResult":                     tk.GetBitXORResult,
	"GetBitANDNOTResult":                  tk.GetBitANDNOTResult,
	"GetMultiplyResult":                   tk.GetMultiplyResult,
	"GetDivResult":                        tk.GetDivResult,
	"GetMinusResult":                      tk.GetMinusResult,
	"GetAddResult":                        tk.GetAddResult,
	"GetAddResultForce":                   tk.GetAddResultForce,
	"GetAddsResult":                       tk.GetAddsResult,
	"GetModResult":                        tk.GetModResult,
	"GetGTResult":                         tk.GetGTResult,
	"GetLTResult":                         tk.GetLTResult,
	"GetGETResult":                        tk.GetGETResult,
	...
	"ReflectGetMethod":                    tk.ReflectGetMethod,
	...
	"EnsureBasePathInHome":         tk.EnsureBasePathInHome,
	...
	"GetNodesStringFromXML":        tk.GetNodesStringFromXML,
	"GetFlexRef":                   tk.GetFlexRef,
	"GetMapRef":                    tk.GetMapRef,
	...
	"GenerateToken":                         tk.GenerateToken,
	...
	"GetRef":                                tk.GetRef,
	"GetRefValue":                           tk.GetRefValue,
	"GetRefValueQuick":                      tk.GetRefValueQuick,
	"Sscanf":                                tk.Sscanf,
	"SetByRef":                              tk.SetByRef,
	"GetAddr":                               tk.GetAddr,
	...
	"RegFindFirstGroupsX":                   tk.RegFindFirstGroupsX,
	...
	"RemoveFirstSubString":                  tk.RemoveFirstSubString,
	...
	"TableToMSSOrderedMap":         tk.TableToMSSOrderedMap,
	"TableToOrderedMapArray":       tk.TableToOrderedMapArray,
